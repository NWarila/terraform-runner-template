...
| Attribution residue | A CI job that scans tracked files and PR commit messages, per [ADR-0010](../decision-records/0010-keep-ai-attribution-out-of-version-control.md) |
