...
| --------------- | ---- | --------------- |
| Namespace `.github` control plane | Org ADRs, community files, universal reusable workflows, org policy | Source-side reusable smoke tests, ADR schema, docs layout, baseline manifest, repo hygiene, attribution-residue scan |
