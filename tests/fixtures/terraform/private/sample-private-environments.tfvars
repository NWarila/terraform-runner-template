# Sample fixture - what `terraform/private/<env>.tfvars` would look like
...
# in.
#
# The contract requires `terraform/private/` and
# `tests/fixtures/terraform/private/` to exist; the production data path is the former, the
# CI-deterministic path is the latter. A real runner's
# pr-validation.yaml typically uses `tests/fixtures/terraform/private/`
